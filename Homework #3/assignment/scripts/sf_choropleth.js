  ...
  var legendThresholds = [[1,25], [25,50], [50,100], [100,200], [200,300], [300,700]];
  ...
  function draw(error, data) {
    ...
    var legend = d3.select("#map")
      ...
      .attr("height", 8)
      .attr("width", (datum) => {
        return legendScale(datum[1] - datum[0]);
      })
    ...
    .call(d3.axisBottom(legendScale).tickValues([1,25,50,100,200,300,700]).tickSize(10));
